...
_STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "health_visit_datetime": "Дата и время: <code>2026-06-25 10:00</code>",
        ...
        "car_enter_date": "Дата (когда напомнить):\n<code>2026-07-15</code> или <code>15.07.2026</code>",
        "car_comp_enter_date": "Дата окончания:\n<code>2026-12-31</code> или <code>31.12.2026</code>",
        "car_enter_notes": "Комментарий (пробег, СТО…) или <code>-</code>",
        "car_date_error": "Формат: YYYY-MM-DD или DD.MM.YYYY",
        ...
        "fin_bill_date_prompt": "Дата оплаты:\n<code>2026-07-05</code> или <code>05.07.2026</code>",
        ...
        "org_task_due_prompt": "Срок (или «-» без срока):\n<code>2026-06-25 18:00</code> или <code>25.06.2026</code>",
        ...
        "vlt_file_hint": "📎 Можно отправить фото или файл — сохранится автоматически.",
        ...
        "ntf_due_prompt": "Дата окончания (ГГГГ-ММ-ДД или ДД.ММ.ГГГГ):",
    ...
    "uz": {
        ...
        "health_visit_datetime": "Sana va vaqt: <code>2026-06-25 10:00</code>",
        ...
        "car_enter_date": "Sana:\n<code>2026-07-15</code> yoki <code>15.07.2026</code>",
        "car_comp_enter_date": "Tugash sanasi:\n<code>2026-12-31</code>",
        "car_enter_notes": "Izoh yoki <code>-</code>",
        "car_date_error": "Format: YYYY-MM-DD yoki DD.MM.YYYY",
        ...
        "fin_bill_date_prompt": "To'lov sanasi:\n<code>2026-07-05</code> yoki <code>05.07.2026</code>",
        ...
        "org_task_due_prompt": "Muddat (yoki «-» muddatsiz):\n<code>2026-06-25 18:00</code> yoki <code>25.06.2026</code>",
        ...
        "org_date_error": "Format: YYYY-MM-DD HH:MM yoki DD.MM.YYYY",
        "ast_module_intro": (
        ...
        "vlt_file_hint": "📎 Foto yoki fayl yuborishingiz mumkin — avtomatik saqlanadi.",
        ...
        "ntf_due_prompt": "Tugash sanasi (YYYY-MM-DD yoki DD.MM.YYYY):",
    ...
    "en": {
        ...
        "health_visit_datetime": "Date & time: <code>2026-06-25 10:00</code>",
        ...
        "fin_bill_date_prompt": "Due date:\n<code>2026-07-05</code> or <code>05.07.2026</code>",
        ...
        "org_task_due_prompt": "Due date (or «-» for none):\n<code>2026-06-25 18:00</code> or <code>25.06.2026</code>",
        ...
        "org_date_error": "Format: YYYY-MM-DD HH:MM or DD.MM.YYYY",
        "ast_module_intro": (
        ...
        "vlt_file_hint": "📎 You can send a photo or file — it will be saved automatically.",
        ...
        "ntf_due_prompt": "Due date (YYYY-MM-DD or DD.MM.YYYY):",
