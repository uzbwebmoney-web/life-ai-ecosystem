...
_STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "settings_vault_lock": "🔐 Защита хранилища: {status}",
        ...
        "search_vault_hidden": "🔐 Записи личного хранилища скрыты — откройте хранилище и введите пароль.",
        ...
        "health_med_btn_taken": "✅ Принял",
        "health_med_btn_skip": "❌ Не принял",
        "health_med_taken_confirm": "✅ Отлично! «{name}» отмечено как принятое.",
        "health_med_snooze_prompt": (
            "⏰ Через сколько планируете принять «<b>{name}</b>»?\n\n"
            "Выберите кнопку или напишите: <code>30</code>, <code>1ч</code>, <code>1:30</code>"
        ),
        "health_med_snooze_invalid": "Укажите время: например <code>15</code>, <code>30 мин</code>, <code>1ч</code>",
        "health_med_snooze_scheduled": "🔔 Напомню через {when} — в {time}",
        "health_med_snooze_15": "15 мин",
        "health_med_snooze_30": "30 мин",
        "health_med_snooze_60": "1 ч",
        "health_med_snooze_120": "2 ч",
        "health_med_snooze_delay_min": "{n} мин",
        "health_med_snooze_delay_h": "{h} ч",
        "health_med_snooze_delay_hm": "{h} ч {m} мин",
        ...
        "ast_image_generating": "🎨 Генерирую изображение. Ожидайте, я вас уведомлю.",
        ...
        "vlt_lock_settings_intro_on": (
            ...
            "Пароль на хранилище включён. При выходе в главное меню доступ блокируется.\n"
            "Также через 30 минут бездействия потребуется пароль снова.\n\n"
            "Пароль хранится в зашифрованном виде только в вашей базе бота."
        ),
        "vlt_lock_enable_btn": "✅ Установить пароль",
        "vlt_lock_disable_btn": "❌ Отключить пароль",
        "vlt_lock_change_btn": "🔑 Сменить пароль",
        "vlt_lock_lock_now_btn": "🔒 Заблокировать сейчас",
        "vlt_lock_set_prompt": "Придумайте пароль (от 4 до 64 символов):",
        "vlt_lock_confirm_prompt": "Повторите пароль:",
        "vlt_lock_old_prompt": "Введите текущий пароль:",
        "vlt_lock_remove_prompt": "Введите пароль, чтобы отключить защиту:",
        "vlt_lock_prompt": "🔐 Личное хранилище защищено паролем.\n\nВведите пароль:",
        "vlt_lock_weak": "Пароль должен быть от 4 до 64 символов.",
        "vlt_lock_mismatch": "Пароли не совпадают. Попробуйте снова.",
        "vlt_lock_wrong": "❌ Неверный пароль.",
        "vlt_lock_enabled": "✅ Пароль установлен. Хранилище защищено.",
        "vlt_lock_disabled": "✅ Защита хранилища отключена.",
        ...
        "admin_new_week": "Новых за 7 дней",
        "admin_new_month": "Новых за 30 дней",
        "admin_active_week": "Активных за 7 дней",
        "admin_onboarding_done": "Прошли онбординг",
        "admin_total_records": "Записей",
        "admin_total_memory": "Память AI",
        "admin_vault_protected": "С паролем на сейф",
        "admin_by_language": "По языкам",
        "admin_menu_intro": "🛠 <b>Админ-панель</b>\n\nСтатистика, поиск пользователей, оплаты.",
        "admin_btn_stats": "📊 Статистика",
        "admin_btn_users": "👥 Последние пользователи",
        "admin_btn_orders": "💰 Заявки на оплату",
        "admin_btn_costs": "💵 Расходы AI",
        "admin_btn_refresh": "🔄 Обновить",
        "admin_btn_back": "↩️ Админ-меню",
        "admin_refreshed": "Обновлено",
        "admin_costs_title": "💵 <b>Расходы на OpenAI</b>",
        "admin_costs_today": "Сегодня",
        "admin_costs_week": "7 дней",
        "admin_costs_month": "30 дней",
        "admin_costs_total": "Всего",
        "admin_costs_requests": "запр.",
        "admin_costs_by_model": "<b>По моделям (30 дней):</b>",
        "admin_costs_model_line": "• {model}: {cost} — {requests} запр. (in {inp}, out {out})",
        "admin_costs_top_users": "<b>Топ пользователей (30 дней):</b>",
        "admin_costs_user_line": "• {user}: {cost} — {requests} запр.",
        "admin_costs_no_data": "Пока нет данных.",
        "admin_costs_rates": "<b>📋 Тарифы OpenAI</b>",
        "admin_costs_images_month": "🎨 Изображения (30 дн.): <b>{count}</b> шт. — {cost}",
        "admin_costs_image_line": "• {model}: {cost} — {count} изобр. ({requests} запр.)",
        "admin_recent_users_title": "👥 <b>Последние пользователи</b>",
        "admin_users_empty": "Пользователей пока нет.",
        "admin_btn_search_user": "🔍 Поиск пользователя",
        "admin_btn_search_again": "🔍 Новый поиск",
        "admin_user_search_prompt": (
            "🔍 <b>Поиск пользователя</b>\n\n"
            "Введите:\n"
            "• внутренний ID — <code>42</code>\n"
            "• Telegram ID — <code>8159351732</code>\n"
            "• username — <code>@buriev2</code> или <code>buriev2</code>"
        ),
        "admin_user_not_found": "Пользователь не найден.",
        "admin_user_found_one": "Найден пользователь:",
        "admin_user_found_many": "Найдено пользователей: <b>{count}</b>. Выберите:",
        "admin_user_card_title": "👤 <b>Пользователь #{user_id}</b>",
        "admin_user_card_identity": "Telegram: <code>{telegram_id}</code> | {username}\nЯзык: <b>{lang_code}</b> · {utc_offset}",
        "admin_user_card_dates": "Регистрация: {created} · Онбординг: {onboarding}",
        "admin_user_card_plan": "Тариф в БД: <b>{stored}</b>\nЭффективный: <b>{effective}</b>",
        "admin_user_card_trial": "Trial до: {date} {mark}",
        "admin_user_card_paid_until": "Оплачен до: {date} {mark}",
        "admin_user_card_usage_header": "<b>Лимиты и расход:</b>",
        "admin_user_card_extra": "<b>Дополнительно:</b>",
        "admin_user_card_reminders": "🔔 Напоминания: {used} / {limit}",
        "admin_user_card_memory": "🧠 Память AI: {used} / {limit}",
        "admin_user_card_storage": "💾 Хранилище: {used} / {limit} MB",
        "admin_user_card_records": "📝 Записей: {count}",
        "admin_user_card_ai_30d": "🤖 AI запросов (30 д): {count}",
        "admin_user_card_referral": "🔗 Реф. код: <code>{code}</code>",
        "admin_user_card_referred_by": "👥 Приглашён пользователем #{user_id}",
        "admin_user_card_ai_left": "Остаток AI: день {daily} · месяц {monthly} · бонус {bonus}",
        "admin_user_btn_extend_plan": "➕30д тариф",
        "admin_user_btn_extend_trial": "➕7д trial",
        "admin_user_btn_reset_usage": "♻️ Сброс расхода",
        "admin_user_btn_reset_credits": "🔄 Обнулить кредиты",
        "admin_user_btn_bonus_100": "➕100 кред.",
        "admin_user_btn_credits_adjust": "💎 ± кредиты",
        "admin_user_btn_refresh": "🔄 Обновить",
        "admin_user_plan_set": "Тариф изменён: {plan}",
        "admin_user_extend_plan_ok": "Тариф продлён на 30 дней",
        "admin_user_extend_plan_fail": "Нельзя продлить Free — сначала назначьте тариф",
        "admin_user_extend_trial_ok": "Trial продлён на 7 дней",
        "admin_user_reset_ok": "Счётчики расхода сброшены",
        "admin_user_credits_prompt": (
            "💎 Изменение AI-кредитов:\n"
            "• <code>500</code> или <code>+500</code> — добавить\n"
            "• <code>-200</code> — отнять\n"
            "• <code>0</code> — обнулить (расход + бонус)"
        ),
        "admin_user_credits_invalid": "Формат: 500, +500, -200 или 0 (от 1 до 1000000)",
        "admin_user_credits_add_ok": "Добавлено +{amount} AI-кредитов",
        "admin_user_credits_sub_ok": "Списано −{amount} AI-кредитов",
        "admin_user_credits_reset_ok": "AI-кредиты обнулены (расход и бонус)",
        "admin_user_bonus_prompt": "Сколько AI-кредитов добавить? (число)",
        "admin_user_bonus_invalid": "Введите число от 1 до 1000000",
        "admin_user_bonus_ok": "Добавлено +{amount} AI-кредитов",
        ...
        "mus_no_vocals_detected": (
            "⚠️ <b>Слова в треке не распознаны</b>\n\n"
    ...
    "uz": {
        ...
        "settings_vault_lock": "🔐 Ombor himoyasi: {status}",
        ...
        "status_on": "✅ yoq.",
        "status_off": "❌ o'ch.",
        "btn_back_settings": "↩️ Sozlamalar",
        ...
        "health_med_btn_taken": "✅ Qabul qildim",
        "health_med_btn_skip": "❌ Qabul qilmadim",
        "health_med_taken_confirm": "✅ Ajoyib! «{name}» qabul qilingan deb belgilandi.",
        "health_med_snooze_prompt": (
            "⏰ «<b>{name}</b>» ni qachon qabul qilmoqchisiz?\n\n"
            "Tugmani tanlang yoki yozing: <code>30</code>, <code>1soat</code>, <code>1:30</code>"
        ),
        "health_med_snooze_invalid": "Vaqtni kiriting: masalan <code>15</code>, <code>30 min</code>, <code>1soat</code>",
        "health_med_snooze_scheduled": "🔔 {when} dan keyin eslataman — soat {time}",
        "health_med_snooze_15": "15 daq",
        "health_med_snooze_30": "30 daq",
        "health_med_snooze_60": "1 soat",
        "health_med_snooze_120": "2 soat",
        "health_med_snooze_delay_min": "{n} daq",
        "health_med_snooze_delay_h": "{h} soat",
        "health_med_snooze_delay_hm": "{h} soat {m} daq",
        ...
        "ast_image_generating": "🎨 Rasm yaratilmoqda. Kuting, sizga xabar beraman.",
        ...
        "vlt_lock_settings_intro_on": (
            ...
            "Ombor paroli yoqilgan. Bosh menyuga chiqsangiz, kirish bloklanadi.\n"
            "30 daqiqa faolsizlikdan keyin ham parol qayta so'raladi.\n\n"
            "Parol shifrlangan holda faqat sizning bot bazangizda saqlanadi."
        ),
        "vlt_lock_enable_btn": "✅ Parol o'rnatish",
        "vlt_lock_disable_btn": "❌ Parolni o'chirish",
        "vlt_lock_change_btn": "🔑 Parolni almashtirish",
        "vlt_lock_lock_now_btn": "🔒 Hozir bloklash",
        "vlt_lock_set_prompt": "Parol o'ylab toping (4–64 belgi):",
        ...
        "vlt_lock_enabled": "✅ Parol o'rnatildi. Ombor himoyalangan.",
        "vlt_lock_disabled": "✅ Ombor himoyasi o'chirildi.",
        "vlt_lock_unlocked": "✅ Kirish ochiq.",
        "vlt_lock_locked_now": "🔒 Ombor bloklandi. Kirishda parol kerak.",
        "vlt_lock_not_enabled": "Himoya hali yoqilmagan.",
        "admin_stats_title": "📊 <b>Bot statistikasi</b>",
        "admin_total_users": "Jami foydalanuvchilar",
        "admin_new_today": "Bugun yangi",
        "admin_new_week": "7 kun ichida yangi",
        "admin_new_month": "30 kun ichida yangi",
        "admin_active_week": "7 kunda faol",
        "admin_onboarding_done": "Onboarding tugagan",
        "admin_total_records": "Yozuvlar",
        "admin_total_memory": "AI xotira",
        "admin_vault_protected": "Seyf paroli bilan",
        "admin_by_language": "Tillar bo'yicha",
        "admin_menu_intro": "🛠 <b>Admin panel</b>\n\nBot foydalanuvchilari statistikasi.",
        "admin_btn_stats": "📊 Statistika",
        "admin_btn_users": "👥 So'nggi foydalanuvchilar",
        "admin_btn_orders": "💰 To'lov arizalari",
        "admin_btn_costs": "💵 AI xarajatlari",
        "admin_btn_refresh": "🔄 Yangilash",
        "admin_btn_back": "↩️ Admin menyu",
        "admin_refreshed": "Yangilandi",
        "admin_costs_title": "💵 <b>OpenAI xarajatlari</b>",
        "admin_costs_today": "Bugun",
        "admin_costs_week": "7 kun",
        "admin_costs_month": "30 kun",
        "admin_costs_total": "Jami",
        "admin_costs_requests": "so'rov",
        "admin_costs_by_model": "<b>Modellar bo'yicha (30 kun):</b>",
        "admin_costs_model_line": "• {model}: {cost} — {requests} so'rov (in {inp}, out {out})",
        "admin_costs_top_users": "<b>Top foydalanuvchilar (30 kun):</b>",
        "admin_costs_user_line": "• {user}: {cost} — {requests} so'rov",
        "admin_costs_no_data": "Hozircha ma'lumot yo'q.",
        "admin_costs_rates": "<b>📋 OpenAI tariflari</b>",
        "admin_costs_images_month": "🎨 Rasmlar (30 kun): <b>{count}</b> ta — {cost}",
        "admin_costs_image_line": "• {model}: {cost} — {count} rasm ({requests} so'rov)",
        "admin_recent_users_title": "👥 <b>So'nggi foydalanuvchilar</b>",
        "admin_users_empty": "Hozircha foydalanuvchilar yo'q.",
        "admin_btn_search_user": "🔍 Foydalanuvchi qidirish",
        "admin_btn_search_again": "🔍 Yangi qidiruv",
        "admin_user_search_prompt": (
            "🔍 <b>Foydalanuvchi qidirish</b>\n\n"
            "Kiriting:\n"
            "• ichki ID — <code>42</code>\n"
            "• Telegram ID — <code>8159351732</code>\n"
            "• username — <code>@buriev2</code> yoki <code>buriev2</code>"
        ),
        "admin_user_not_found": "Foydalanuvchi topilmadi.",
        "admin_user_found_one": "Foydalanuvchi topildi:",
        "admin_user_found_many": "Topildi: <b>{count}</b>. Tanlang:",
        "admin_user_card_title": "👤 <b>Foydalanuvchi #{user_id}</b>",
        "admin_user_card_identity": "Telegram: <code>{telegram_id}</code> | {username}\nTil: <b>{lang_code}</b> · {utc_offset}",
        "admin_user_card_dates": "Ro'yxat: {created} · Onboarding: {onboarding}",
        "admin_user_card_plan": "BD tarifi: <b>{stored}</b>\nAmaldagi: <b>{effective}</b>",
        "admin_user_card_trial": "Trial: {date} {mark}",
        "admin_user_card_paid_until": "To'langan: {date} {mark}",
        "admin_user_card_usage_header": "<b>Limitlar va sarflanish:</b>",
        "admin_user_card_extra": "<b>Qo'shimcha:</b>",
        "admin_user_card_reminders": "🔔 Eslatmalar: {used} / {limit}",
        "admin_user_card_memory": "🧠 AI xotira: {used} / {limit}",
        "admin_user_card_storage": "💾 Saqlash: {used} / {limit} MB",
        "admin_user_card_records": "📝 Yozuvlar: {count}",
        "admin_user_card_ai_30d": "🤖 AI so'rovlar (30 k): {count}",
        "admin_user_card_referral": "🔗 Ref. kod: <code>{code}</code>",
        "admin_user_card_referred_by": "👥 Taklif qilgan: #{user_id}",
        "admin_user_card_ai_left": "AI qoldiq: kun {daily} · oy {monthly} · bonus {bonus}",
        "admin_user_btn_extend_plan": "➕30k tarif",
        "admin_user_btn_extend_trial": "➕7k trial",
        "admin_user_btn_reset_usage": "♻️ Sarfni tozalash",
        "admin_user_btn_reset_credits": "🔄 Kreditlarni nolga",
        "admin_user_btn_bonus_100": "➕100 kredit",
        "admin_user_btn_credits_adjust": "💎 ± kreditlar",
        "admin_user_btn_refresh": "🔄 Yangilash",
        "admin_user_plan_set": "Tarif o'zgartirildi: {plan}",
        "admin_user_extend_plan_ok": "Tarif 30 kunga uzaytirildi",
        "admin_user_extend_plan_fail": "Free tarifni uzaytirib bo'lmaydi",
        "admin_user_extend_trial_ok": "Trial 7 kunga uzaytirildi",
        "admin_user_reset_ok": "Sarflanish hisoblagichlari tozalandi",
        "admin_user_credits_prompt": (
            "💎 AI-kredit o'zgartirish:\n"
            "• <code>500</code> yoki <code>+500</code> — qo'shish\n"
            "• <code>-200</code> — ayirish\n"
            "• <code>0</code> — nolga tushirish"
        ),
        "admin_user_credits_invalid": "Format: 500, +500, -200 yoki 0 (1–1000000)",
        "admin_user_credits_add_ok": "+{amount} AI-kredit qo'shildi",
        "admin_user_credits_sub_ok": "−{amount} AI-kredit ayirildi",
        "admin_user_credits_reset_ok": "AI-kreditlar nolga tushirildi",
        "admin_user_bonus_prompt": "Nechta AI-kredit qo'shilsin? (raqam)",
        "admin_user_bonus_invalid": "1 dan 1000000 gacha raqam kiriting",
        "admin_user_bonus_ok": "+{amount} AI-kredit qo'shildi",
    ...
    "en": {
        ...
        "settings_vault_lock": "🔐 Vault protection: {status}",
        ...
        "search_vault_hidden": "🔐 Personal vault entries are hidden — open the vault and enter your password.",
        ...
        "health_med_btn_taken": "✅ Taken",
        "health_med_btn_skip": "❌ Skipped",
        "health_med_taken_confirm": "✅ Great! «{name}» marked as taken.",
        "health_med_snooze_prompt": (
            "⏰ When will you take «<b>{name}</b>»?\n\n"
            "Pick a button or type: <code>30</code>, <code>1h</code>, <code>1:30</code>"
        ),
        "health_med_snooze_invalid": "Enter time: e.g. <code>15</code>, <code>30 min</code>, <code>1h</code>",
        "health_med_snooze_scheduled": "🔔 I'll remind you in {when} — at {time}",
        "health_med_snooze_15": "15 min",
        "health_med_snooze_30": "30 min",
        "health_med_snooze_60": "1 h",
        "health_med_snooze_120": "2 h",
        "health_med_snooze_delay_min": "{n} min",
        "health_med_snooze_delay_h": "{h} h",
        "health_med_snooze_delay_hm": "{h} h {m} min",
        ...
        "ast_image_generating": "🎨 Generating image. Please wait, I'll notify you.",
        ...
        "vlt_lock_settings_intro_on": (
            ...
            "Vault password is enabled. Leaving for the main menu locks access.\n"
            "After 30 minutes of inactivity you'll need the password again.\n\n"
            "The password is stored hashed only in your bot database."
        ),
        "vlt_lock_enable_btn": "✅ Set password",
        "vlt_lock_disable_btn": "❌ Remove password",
        "vlt_lock_change_btn": "🔑 Change password",
        "vlt_lock_lock_now_btn": "🔒 Lock now",
        "vlt_lock_set_prompt": "Choose a password (4–64 characters):",
        "vlt_lock_confirm_prompt": "Repeat the password:",
        "vlt_lock_old_prompt": "Enter current password:",
        "vlt_lock_remove_prompt": "Enter password to disable protection:",
        "vlt_lock_prompt": "🔐 Personal vault is password-protected.\n\nEnter password:",
        "vlt_lock_weak": "Password must be 4–64 characters.",
        "vlt_lock_mismatch": "Passwords don't match. Try again.",
        "vlt_lock_wrong": "❌ Wrong password.",
        "vlt_lock_enabled": "✅ Password set. Vault is protected.",
        "vlt_lock_disabled": "✅ Vault protection disabled.",
        "vlt_lock_unlocked": "✅ Access granted.",
        "vlt_lock_locked_now": "🔒 Vault locked. Password required on entry.",
        "vlt_lock_not_enabled": "Protection is not enabled yet.",
        "admin_stats_title": "📊 <b>Bot statistics</b>",
        "admin_total_users": "Total users",
        "admin_new_today": "New today",
        "admin_new_week": "New in 7 days",
        "admin_new_month": "New in 30 days",
        "admin_active_week": "Active in 7 days",
        "admin_onboarding_done": "Completed onboarding",
        "admin_total_records": "Records",
        "admin_total_memory": "AI memory",
        "admin_vault_protected": "Vault password on",
        "admin_by_language": "By language",
        "admin_menu_intro": "🛠 <b>Admin panel</b>\n\nBot user statistics.",
        "admin_btn_stats": "📊 Statistics",
        "admin_btn_users": "👥 Recent users",
        "admin_btn_orders": "💰 Payment orders",
        "admin_btn_costs": "💵 AI costs",
        "admin_btn_refresh": "🔄 Refresh",
        "admin_btn_back": "↩️ Admin menu",
        "admin_refreshed": "Updated",
        "admin_costs_title": "💵 <b>OpenAI costs</b>",
        "admin_costs_today": "Today",
        "admin_costs_week": "7 days",
        "admin_costs_month": "30 days",
        "admin_costs_total": "All time",
        "admin_costs_requests": "req.",
        "admin_costs_by_model": "<b>By model (30 days):</b>",
        "admin_costs_model_line": "• {model}: {cost} — {requests} req. (in {inp}, out {out})",
        "admin_costs_top_users": "<b>Top users (30 days):</b>",
        "admin_costs_user_line": "• {user}: {cost} — {requests} req.",
        "admin_costs_no_data": "No data yet.",
        "admin_costs_rates": "<b>📋 OpenAI rates</b>",
        "admin_costs_images_month": "🎨 Images (30 days): <b>{count}</b> — {cost}",
        "admin_costs_image_line": "• {model}: {cost} — {count} images ({requests} req.)",
        "admin_recent_users_title": "👥 <b>Recent users</b>",
        "admin_users_empty": "No users yet.",
        "admin_btn_search_user": "🔍 Find user",
        "admin_btn_search_again": "🔍 New search",
        "admin_user_search_prompt": (
            "🔍 <b>Find user</b>\n\n"
            "Enter:\n"
            "• internal ID — <code>42</code>\n"
            "• Telegram ID — <code>8159351732</code>\n"
            "• username — <code>@buriev2</code> or <code>buriev2</code>"
        ),
        "admin_user_not_found": "User not found.",
        "admin_user_found_one": "User found:",
        "admin_user_found_many": "Found <b>{count}</b> users. Pick one:",
        "admin_user_card_title": "👤 <b>User #{user_id}</b>",
        "admin_user_card_identity": "Telegram: <code>{telegram_id}</code> | {username}\nLanguage: <b>{lang_code}</b> · {utc_offset}",
        "admin_user_card_dates": "Joined: {created} · Onboarding: {onboarding}",
        "admin_user_card_plan": "DB plan: <b>{stored}</b>\nEffective: <b>{effective}</b>",
        "admin_user_card_trial": "Trial until: {date} {mark}",
        "admin_user_card_paid_until": "Paid until: {date} {mark}",
        "admin_user_card_usage_header": "<b>Limits & usage:</b>",
        "admin_user_card_extra": "<b>Extra:</b>",
        "admin_user_card_reminders": "🔔 Reminders: {used} / {limit}",
        "admin_user_card_memory": "🧠 AI memory: {used} / {limit}",
        "admin_user_card_storage": "💾 Storage: {used} / {limit} MB",
        "admin_user_card_records": "📝 Records: {count}",
        "admin_user_card_ai_30d": "🤖 AI requests (30d): {count}",
        "admin_user_card_referral": "🔗 Referral code: <code>{code}</code>",
        "admin_user_card_referred_by": "👥 Referred by user #{user_id}",
        "admin_user_card_ai_left": "AI left: daily {daily} · monthly {monthly} · bonus {bonus}",
        "admin_user_btn_extend_plan": "➕30d plan",
        "admin_user_btn_extend_trial": "➕7d trial",
        "admin_user_btn_reset_usage": "♻️ Reset usage",
        "admin_user_btn_reset_credits": "🔄 Zero credits",
        "admin_user_btn_bonus_100": "➕100 cr.",
        "admin_user_btn_credits_adjust": "💎 ± credits",
        "admin_user_btn_refresh": "🔄 Refresh",
        "admin_user_plan_set": "Plan set: {plan}",
        "admin_user_extend_plan_ok": "Plan extended by 30 days",
        "admin_user_extend_plan_fail": "Cannot extend Free — assign a plan first",
        "admin_user_extend_trial_ok": "Trial extended by 7 days",
        "admin_user_reset_ok": "Usage counters reset",
        "admin_user_credits_prompt": (
            "💎 Adjust AI credits:\n"
            "• <code>500</code> or <code>+500</code> — add\n"
            "• <code>-200</code> — subtract\n"
            "• <code>0</code> — reset usage + bonus"
        ),
        "admin_user_credits_invalid": "Format: 500, +500, -200 or 0 (1–1000000)",
        "admin_user_credits_add_ok": "Added +{amount} AI credits",
        "admin_user_credits_sub_ok": "Subtracted −{amount} AI credits",
        "admin_user_credits_reset_ok": "AI credits reset (usage + bonus)",
        "admin_user_bonus_prompt": "How many AI credits to add?",
        "admin_user_bonus_invalid": "Enter a number from 1 to 1000000",
        "admin_user_bonus_ok": "Added +{amount} AI credits",
