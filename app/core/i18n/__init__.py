...
_STRINGS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "admin_costs_rates": "<i>Тарифы: input / output за 1M токенов</i>",
    ...
    "uz": {
        ...
        "admin_costs_rates": "<i>Tariflar: input / output 1M token uchun</i>",
    ...
    "en": {
        ...
        "admin_costs_rates": "<i>Rates: input / output per 1M tokens</i>",
