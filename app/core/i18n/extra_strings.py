EXTRA_RU: dict[str, str] = {
    ...
    "dash_daily_tip": "Просто напишите — AI сам выберет нужные разделы и предложит действия.",
    "btn_scan": "📷 Сканер",
    "btn_sos": "🚨 SOS",
    ...
    "household_join_full": "⚠️ В семье владельца достигнут лимит участников по тарифу.",
    ...
    "sub_btn_share_referral": "📤 Поделиться ссылкой",
    ...
    "quota_export": "📦 Экспорт данных доступен от тарифа Student.",
    "quota_family_profiles": "⚠️ Лимит семейных профилей ({used}/{limit}).",
    "pay_already_processed": "✅ Эта оплата уже была обработана ранее.",
    ...
    "btn_agent_modes": "🎭 Режимы AI",
    "agent_working": "🤖 Выполняю задачу…",
    "agent_confirm_title": "🤖 <b>Подтвердите действия:</b>",
    "agent_confirm_hint": "Нажмите «Выполнить» или «Отмена».",
    "agent_btn_confirm": "✅ Выполнить",
    "agent_btn_cancel": "❌ Отмена",
    "agent_executing": "⏳ Выполняю…",
    "agent_cancelled": "❌ Действия отменены.",
    "agent_plan_expired": "План устарел — повторите запрос.",
    "agent_nothing_executed": "ℹ️ Нет действий для выполнения.",
    "agent_errors": "⚠️ Ошибки:",
    "agent_prefix_default": "🤖 <b>Готово:</b>",
    "agent_prefix_child": "🤖 <b>Готово!</b>",
    "agent_prefix_elder": "🤖 <b>Сделано:</b>",
    "agent_spending_title": "📊 Расходы за {days} дн.",
    "agent_spending_total": "Итого: {total} UZS",
    "agent_spending_change": "Изменение: {pct}% ({direction})",
    "agent_spending_up": "больше",
    "agent_spending_down": "меньше",
    "agent_spending_by_cat": "По категориям:",
    "agent_fitness_no_data": "Нет данных о тренировках.",
    "agent_fitness_stats": "Тренировки: выполнено {done}, пропущено {missed} из {total}.",
    "agent_no_web_results": "В интернете ничего не найдено — отвечаю на основе знаний AI.",
    "today_full_title": "Сегодня — полный обзор",
    "today_finance": "Финансы",
    "today_finance_line": "Доходы: {income} UZS · Расходы: {expense} UZS",
    "today_credits": "Кредиты",
    "today_car": "Авто",
    "today_tasks": "Задачи",
    "today_tasks_done": "Выполнено задач: {n}",
    "today_meds": "Лекарства",
    "today_fx": "Курсы (справочно)",
    "today_fx_line": "1 USD ≈ {usd} · 1 EUR ≈ {eur}",
    "today_subscription": "Подписка",
    "today_subscription_line": "{emoji} {plan}",
    "today_news_hint": "Спросите AI: «Новости [тема]» — найду актуальное в интернете.",
    "uni_thinking": "🧠 Думаю и связываю данные из всех разделов…",
    "uni_reply_prefix": "🤖 AI ({modules})",
    "uni_system_prompt": (
        "Ты единый персональный AI-помощник «Моя жизнь». Пользователь не выбирает разделы — "
        "ты сам используешь контекст модулей: {modules}. Связывай данные между финансами, домом, "
        "здоровьем, авто, поездками, сейфом и органайзером. Предлагай конкретные следующие шаги."
    ),
    "uni_ctx_header": "🔗 Связанный контекст:",
    "uni_ctx_meds": "Лекарства",
    "uni_ctx_visits": "Визиты",
    "uni_ctx_car": "Авто",
    "uni_ctx_passport": "Документы",
    "uni_ctx_tasks": "Задачи",
    "uni_ctx_reminders": "Напоминания",
    "uni_btn_save": "💾 Сохранить",
    "uni_btn_dismiss": "Пропустить",
    "uni_saved_ok": "✅ Сохранено в память",
    "uni_file_modules": "Связанные разделы: {modules}",
    "uni_act_symptom_diary": "📓 Дневник симптомов",
    "uni_act_doctor_visit": "🩺 Записать визит",
    "uni_act_warranty": "📄 Сохранить гарантию",
    "uni_act_inventory": "🏠 Добавить домой",
    "uni_act_travel_budget": "💰 Бюджет поездки",
    "uni_act_use_passport": "✈️ Использовать для поездки",
    "btn_today": "📊 Сегодня",
    "btn_projects": "📁 Проекты",
    "btn_workspace": "🗂 Workspace",
    "btn_subscription_short": "⭐ Подписка",
    "btn_save_memory_short": "🧠 Память",
    "btn_remind": "⏰ Напомнить",
    "btn_export": "📤 Экспорт",
    "btn_project_new": "➕ Новый проект",
    "project_empty": "Проектов пока нет — нажмите «Новый проект».",
    "project_title_prompt": "Название нового проекта:",
    "project_title_short": "Название слишком короткое.",
    "rk_menu": "🏠 Главная",
    "rk_menu_ready": "🏠 Меню — кнопка внизу экрана",
    "rk_today": "📊 Сегодня",
    "rk_search": "🔍 Поиск",
    "rk_scan": "📷 Скан",
    "rk_settings": "⚙️ Настройки",
    "rk_active": "⬇️ Быстрые кнопки внизу — ими удобнее пользоваться.",
    "use_buttons_hint": "Команды не нужны — используйте кнопки на главной или внизу экрана.",
    "use_buttons_expense": "Расход: раздел «Финансы» или напишите AI «купил … за … сум».",
    "evening_summary_title": "Итоги дня",
    "evening_tasks_done": "✅ Выполнено задач: {n}",
    "evening_tasks_open": "📋 Открытых задач: {n}",
    "evening_tomorrow": "Завтра",
    "evening_expiring": "⚠️ {title} — {when}",
    "evening_tip": "Хорошего вечера! Завтра напомню о важном.",
    "project_list_title": "📁 <b>AI-проекты</b>",
    "project_active": "Активный: <b>{title}</b>",
    "project_help": "Выберите проект или создайте новый кнопкой ниже.",
    "project_created": "✅ Проект создан: <b>{title}</b>",
    "project_switched": "📌 Активный проект переключён.",
    "mode_menu_title": "🎭 <b>Режимы и персонализация</b>",
    "mode_ui_normal": "👤 Обычный режим",
    "mode_ui_child": "🧒 Режим ребёнка",
    "mode_ui_elder": "👴 Режим для старших",
    "mode_style_brief": "✂️ Краткие ответы",
    "mode_style_detailed": "📖 Подробные ответы",
    "mode_ui_set_normal": "✅ Обычный режим включён",
    "mode_ui_set_child": "✅ Режим ребёнка включён",
    "mode_ui_set_elder": "✅ Режим для старших включён",
    "mode_style_set": "✅ Стиль ответов: {style}",
    "mode_level_set": "✅ Уровень знаний: {level}",
    "btn_family_calendar": "📅 Семейный календарь",
    "family_calendar_title": "👨‍👩‍👧 <b>Семейный календарь</b>",
    "family_calendar_by": "{author}",
    "search_workspace": "📂 Файлы workspace",
    "workspace_hit_line": "• {title} — {preview}",
    "workspace_list_title": "📂 <b>Workspace — ваши файлы</b>",
    "workspace_empty": "Пока нет проиндексированных файлов.",
    "workspace_hint": "Отправьте PDF, Word или TXT — бот проиндексирует текст для поиска.",
    "workspace_indexed": "✅ Файл «{title}» проиндексирован ({chars} символов). Теперь можно искать: «найди договор аренды».",
    "workspace_indexed_short": "📂 Проиндексировано для поиска: {chars} символов.",
    "doc_saved_indexed": "✅ {name} сохранён и проиндексирован ({chars} символов).",
    "edu_export_format_pptx": "PowerPoint (PPTX)",
}
...
EXTRA_UZ: dict[str, str] = {
    ...
    "dash_daily_tip": "Shunchaki yozing — AI kerakli bo'limlarni tanlaydi va taklif beradi.",
    "btn_scan": "📷 Skaner",
    "btn_sos": "🚨 SOS",
    ...
    "quota_ai_monthly": "⚠️ Oylik AI limiti tugadi. /subscription",
    "quota_ocr": "📄 OCR — Basic dan. /subscription",
    "quota_doc_translate": "🌐 Hujjat tarjimasi — Basic dan. /subscription",
    "quota_pdf": "📎 PDF/DOCX — Basic dan. /subscription",
    "quota_student_module": "🎓 Bo'lim {plan} tarifidan. /subscription",
    "quota_advanced_model": "🧠 GPT-5.4 Mini tarifingizda yo'q. /subscription",
    "quota_advanced_model_monthly": "⚠️ GPT-5.4 Mini limiti {used}/{limit}. /subscription",
    "quota_pro_model": "🚀 GPT-5.5 tarifingizda yo'q. /subscription",
    "quota_pro_model_monthly": "⚠️ GPT-5.5 limiti {used}/{limit}. /subscription",
    "quota_photo_monthly": "⚠️ Foto tahlili limiti {used}/{limit}. /subscription",
    "quota_reminders": "⚠️ Eslatmalar limiti {used}/{limit}. /subscription",
    "quota_memory": "⚠️ Xotira limiti {used}/{limit}. /subscription",
    "quota_storage": "⚠️ Saqlash {used}/{limit} MB. /subscription",
    "quota_export": "📦 Eksport Student tarifidan.",
    "quota_family_profiles": "⚠️ Oilaviy profillar limiti ({used}/{limit}).",
    "household_join_full": "⚠️ Oilaviy akkauntda a'zolar limiti tugagan.",
    ...
    "btn_agent_modes": "🎭 AI rejimlari",
    "agent_working": "🤖 Vazifani bajaryapman…",
    "agent_confirm_title": "🤖 <b>Amallarni tasdiqlang:</b>",
    "agent_confirm_hint": "«Bajarish» yoki «Bekor qilish».",
    "agent_btn_confirm": "✅ Bajarish",
    "agent_btn_cancel": "❌ Bekor",
    "agent_executing": "⏳ Bajarilmoqda…",
    "agent_cancelled": "❌ Bekor qilindi.",
    "agent_plan_expired": "Reja eskirgan — qayta yuboring.",
    "agent_nothing_executed": "ℹ️ Bajariladigan amal yo'q.",
    "agent_errors": "⚠️ Xatolar:",
    "agent_prefix_default": "🤖 <b>Tayyor:</b>",
    "agent_prefix_child": "🤖 <b>Tayyor!</b>",
    "agent_prefix_elder": "🤖 <b>Bajarildi:</b>",
    "agent_spending_title": "📊 {days} kun xarajat",
    "agent_spending_total": "Jami: {total} UZS",
    "agent_spending_change": "O'zgarish: {pct}% ({direction})",
    "agent_spending_up": "ko'proq",
    "agent_spending_down": "kamroq",
    "agent_spending_by_cat": "Kategoriyalar:",
    "agent_fitness_no_data": "Mashq ma'lumoti yo'q.",
    "agent_fitness_stats": "Mashq: bajarildi {done}, o'tkazildi {missed} / {total}.",
    "agent_no_web_results": "Internetdan topilmadi — AI bilimlari asosida javob beraman.",
    "today_full_title": "Bugun — to'liq ko'rinish",
    "today_finance": "Moliya",
    "today_finance_line": "Daromad: {income} · Xarajat: {expense} UZS",
    "today_credits": "Kreditlar",
    "today_car": "Avto",
    "today_tasks": "Vazifalar",
    "today_tasks_done": "Bajarilgan: {n}",
    "today_meds": "Dori-darmonlar",
    "today_fx": "Valyuta kurslari (ma'lumot)",
    "today_fx_line": "1 USD ≈ {usd} · 1 EUR ≈ {eur}",
    "today_subscription": "Obuna",
    "today_subscription_line": "{emoji} {plan}",
    "today_news_hint": "AI ga yozing: «Yangiliklar [mavzu]» — internetdan topaman.",
    "uni_thinking": "🧠 Barcha bo'limlardan ma'lumot bog'layapman…",
    "uni_reply_prefix": "🤖 AI ({modules})",
    "uni_system_prompt": (
        "Siz yagona shaxsiy AI yordamchisiz «Mening hayotim». Foydalanuvchi bo'lim tanlamaydi — "
        "siz modul kontekstidan foydalanasiz: {modules}. Moliya, uy, salomatlik, avto, sayohat, "
        "seyf va organizer ma'lumotlarini bog'lang."
    ),
    "uni_ctx_header": "🔗 Bog'liq kontekst:",
    "uni_ctx_meds": "Dori-darmonlar",
    "uni_ctx_visits": "Tashriflar",
    "uni_ctx_car": "Avto",
    "uni_ctx_passport": "Hujjatlar",
    "uni_ctx_tasks": "Vazifalar",
    "uni_ctx_reminders": "Eslatmalar",
    "uni_btn_save": "💾 Saqlash",
    "uni_btn_dismiss": "O'tkazish",
    "uni_saved_ok": "✅ Xotiraga saqlandi",
    "uni_file_modules": "Bog'liq bo'limlar: {modules}",
    "uni_act_symptom_diary": "📓 Simptomlar kundaligi",
    "uni_act_doctor_visit": "🩺 Shifokor tashrifi",
    "uni_act_warranty": "📄 Kafolatni saqlash",
    "uni_act_inventory": "🏠 Uyga qo'shish",
    "uni_act_travel_budget": "💰 Sayohat byudjeti",
    "uni_act_use_passport": "✈️ Sayohat uchun ishlatish",
    "btn_today": "📊 Bugun",
    "btn_projects": "📁 Loyihalar",
    "btn_workspace": "🗂 Workspace",
    "btn_subscription_short": "⭐ Obuna",
    "btn_save_memory_short": "🧠 Xotira",
    "btn_remind": "⏰ Eslatma",
    "btn_export": "📤 Eksport",
    "btn_project_new": "➕ Yangi loyiha",
    "project_empty": "Loyihalar yo'q — «Yangi loyiha» bosing.",
    "project_title_prompt": "Yangi loyiha nomi:",
    "project_title_short": "Nom juda qisqa.",
    "rk_menu": "🏠 Bosh sahifa",
    "rk_menu_ready": "🏠 Menyu pastdagi tugmada",
    "rk_menu_ready": "🏠 Menyu pastdagi tugmada",
    "rk_today": "📊 Bugun",
    "rk_search": "🔍 Qidiruv",
    "rk_scan": "📷 Skan",
    "rk_settings": "⚙️ Sozlamalar",
    "rk_active": "⬇️ Tezkor tugmalar pastda — ulardan foydalaning.",
    "use_buttons_hint": "Buyruqlar kerak emas — bosh sahifa yoki pastdagi tugmalardan foydalaning.",
    "use_buttons_expense": "Xarajat: «Moliya» bo'limi yoki AI ga «sotib oldim …» deb yozing.",
    "evening_summary_title": "Kun xulosasi",
    "evening_tasks_done": "✅ Bajarildi: {n}",
    "evening_tasks_open": "📋 Ochiq: {n}",
    "evening_tomorrow": "Ertaga",
    "evening_expiring": "⚠️ {title} — {when}",
    "evening_tip": "Xayrli kech!",
    "project_list_title": "📁 <b>AI loyihalar</b>",
    "project_active": "Faol: <b>{title}</b>",
    "project_help": "Loyihani tanlang yoki «Yangi loyiha» bosing.",
    "project_created": "✅ Loyiha yaratildi: <b>{title}</b>",
    "project_switched": "📌 Faol loyiha o'zgartirildi.",
    "mode_menu_title": "🎭 <b>Rejimlar</b>",
    "mode_ui_normal": "👤 Oddiy",
    "mode_ui_child": "🧒 Bolalar",
    "mode_ui_elder": "👴 Katta yosh",
    "mode_style_brief": "✂️ Qisqa javob",
    "mode_style_detailed": "📖 Batafsil",
    "mode_ui_set_normal": "✅ Oddiy rejim",
    "mode_ui_set_child": "✅ Bolalar rejimi",
    "mode_ui_set_elder": "✅ Katta yosh rejimi",
    "mode_style_set": "✅ Uslub: {style}",
    "mode_level_set": "✅ Daraja: {level}",
    "btn_family_calendar": "📅 Oilaviy taqvim",
    "family_calendar_title": "👨‍👩‍👧 <b>Oilaviy taqvim</b>",
    "family_calendar_by": "{author}",
    "search_workspace": "📂 Workspace fayllar",
    "workspace_hit_line": "• {title} — {preview}",
    "workspace_list_title": "📂 <b>Workspace</b>",
    "workspace_empty": "Fayllar yo'q.",
    "workspace_hint": "PDF, Word yoki TXT yuboring.",
    "workspace_indexed": "✅ «{title}» indekslandi ({chars} belgi).",
    "workspace_indexed_short": "📂 Indekslangan: {chars} belgi.",
    "doc_saved_indexed": "✅ {name} saqlandi va indekslandi ({chars} belgi).",
    "edu_export_format_pptx": "PowerPoint (PPTX)",
}
...
EXTRA_EN: dict[str, str] = {
    ...
    "dash_daily_tip": "Just write — AI picks the right modules and suggests actions.",
    "btn_scan": "📷 Scan",
    "btn_sos": "🚨 SOS",
    ...
    "quota_ocr": "📄 OCR from Basic plan. /subscription",
    "quota_doc_translate": "🌐 Document translation from Basic. /subscription",
    "quota_pdf": "📎 PDF/DOCX from Basic. /subscription",
    "quota_student_module": "🎓 Section from {plan} plan. /subscription",
    "quota_advanced_model": "🧠 GPT-5.4 Mini not on your plan. /subscription",
    "quota_advanced_model_monthly": "⚠️ GPT-5.4 Mini limit {used}/{limit}. /subscription",
    "quota_pro_model": "🚀 GPT-5.5 not on your plan. /subscription",
    "quota_pro_model_monthly": "⚠️ GPT-5.5 limit {used}/{limit}. /subscription",
    "quota_photo_monthly": "⚠️ Photo analysis limit {used}/{limit}. /subscription",
    "quota_export": "📦 Data export from Student plan.",
    "quota_family_profiles": "⚠️ Family profile limit ({used}/{limit}).",
    "household_join_full": "⚠️ Family member limit reached on owner's plan.",
    "sub_vault_lock_on": "🔐 Protected vault: password lock",
    "sub_vault_lock_off": "🔐 Vault: no password (protection from Student)",
    ...
    "sub_gpt54_monthly": "GPT-5.4 Mini: {used} / {limit}",
    "sub_gpt55_monthly": "GPT-5.5: {used} / {limit}",
    "sub_btn_share_referral": "📤 Share invite link",
    ...
    "btn_agent_modes": "🎭 AI modes",
    "agent_working": "🤖 Working on it…",
    "agent_confirm_title": "🤖 <b>Confirm actions:</b>",
    "agent_confirm_hint": "Tap Execute or Cancel.",
    "agent_btn_confirm": "✅ Execute",
    "agent_btn_cancel": "❌ Cancel",
    "agent_executing": "⏳ Executing…",
    "agent_cancelled": "❌ Cancelled.",
    "agent_plan_expired": "Plan expired — try again.",
    "agent_nothing_executed": "ℹ️ Nothing to execute.",
    "agent_errors": "⚠️ Errors:",
    "agent_prefix_default": "🤖 <b>Done:</b>",
    "agent_prefix_child": "🤖 <b>Done!</b>",
    "agent_prefix_elder": "🤖 <b>Completed:</b>",
    "agent_spending_title": "📊 Spending ({days}d)",
    "agent_spending_total": "Total: {total} UZS",
    "agent_spending_change": "Change: {pct}% ({direction})",
    "agent_spending_up": "more",
    "agent_spending_down": "less",
    "agent_spending_by_cat": "By category:",
    "agent_fitness_no_data": "No workout data.",
    "agent_fitness_stats": "Workouts: done {done}, missed {missed} of {total}.",
    "agent_no_web_results": "No web results — answering from AI knowledge.",
    "today_full_title": "Today — full overview",
    "today_finance": "Finance",
    "today_finance_line": "Income: {income} · Expenses: {expense} UZS",
    "today_credits": "Loans",
    "today_car": "Car",
    "today_tasks": "Tasks",
    "today_tasks_done": "Tasks done: {n}",
    "today_meds": "Medications",
    "today_fx": "Exchange rates (reference)",
    "today_fx_line": "1 USD ≈ {usd} · 1 EUR ≈ {eur}",
    "today_subscription": "Subscription",
    "today_subscription_line": "{emoji} {plan}",
    "today_news_hint": "Ask AI: «News [topic]» — I'll search the web.",
    "uni_thinking": "🧠 Thinking and linking data across all modules…",
    "uni_reply_prefix": "🤖 AI ({modules})",
    "uni_system_prompt": (
        "You are the unified personal AI assistant «My Life». The user does not pick modules — "
        "you use context from: {modules}. Connect finance, home, health, car, travel, vault and organizer data."
    ),
    "uni_ctx_header": "🔗 Related context:",
    "uni_ctx_meds": "Medications",
    "uni_ctx_visits": "Visits",
    "uni_ctx_car": "Car",
    "uni_ctx_passport": "Documents",
    "uni_ctx_tasks": "Tasks",
    "uni_ctx_reminders": "Reminders",
    "uni_btn_save": "💾 Save",
    "uni_btn_dismiss": "Skip",
    "uni_saved_ok": "✅ Saved to memory",
    "uni_file_modules": "Related modules: {modules}",
    "uni_act_symptom_diary": "📓 Symptom diary",
    "uni_act_doctor_visit": "🩺 Log doctor visit",
    "uni_act_warranty": "📄 Save warranty",
    "uni_act_inventory": "🏠 Add to home",
    "uni_act_travel_budget": "💰 Trip budget",
    "uni_act_use_passport": "✈️ Use for travel",
    "btn_today": "📊 Today",
    "btn_projects": "📁 Projects",
    "btn_workspace": "🗂 Workspace",
    "btn_subscription_short": "⭐ Plan",
    "btn_save_memory_short": "🧠 Memory",
    "btn_remind": "⏰ Remind",
    "btn_export": "📤 Export",
    "btn_project_new": "➕ New project",
    "project_empty": "No projects yet — tap «New project».",
    "project_title_prompt": "New project title:",
    "project_title_short": "Title is too short.",
    "rk_menu": "🏠 Home",
    "rk_menu_ready": "🏠 Menu button is at the bottom",
    "rk_today": "📊 Today",
    "rk_search": "🔍 Search",
    "rk_scan": "📷 Scan",
    "rk_settings": "⚙️ Settings",
    "rk_active": "⬇️ Quick buttons below — use them instead of commands.",
    "use_buttons_hint": "No commands needed — use buttons on Home or at the bottom.",
    "use_buttons_expense": "Expense: Finance section or tell AI «bought … for …».",
    "evening_summary_title": "Evening summary",
    "evening_tasks_done": "✅ Done: {n}",
    "evening_tasks_open": "📋 Open: {n}",
    "evening_tomorrow": "Tomorrow",
    "evening_expiring": "⚠️ {title} — {when}",
    "evening_tip": "Good evening!",
    "project_list_title": "📁 <b>AI projects</b>",
    "project_active": "Active: <b>{title}</b>",
    "project_help": "Pick a project or tap «New project».",
    "project_created": "✅ Project created: <b>{title}</b>",
    "project_switched": "📌 Active project switched.",
    "mode_menu_title": "🎭 <b>Modes & personalization</b>",
    "mode_ui_normal": "👤 Normal",
    "mode_ui_child": "🧒 Child mode",
    "mode_ui_elder": "👴 Elder mode",
    "mode_style_brief": "✂️ Brief",
    "mode_style_detailed": "📖 Detailed",
    "mode_ui_set_normal": "✅ Normal mode",
    "mode_ui_set_child": "✅ Child mode",
    "mode_ui_set_elder": "✅ Elder mode",
    "mode_style_set": "✅ Style: {style}",
    "mode_level_set": "✅ Level: {level}",
    "btn_family_calendar": "📅 Family calendar",
    "family_calendar_title": "👨‍👩‍👧 <b>Family calendar</b>",
    "family_calendar_by": "{author}",
    "search_workspace": "📂 Workspace files",
    "workspace_hit_line": "• {title} — {preview}",
    "workspace_list_title": "📂 <b>Workspace</b>",
    "workspace_empty": "No indexed files yet.",
    "workspace_hint": "Send PDF, Word or TXT to index for search.",
    "workspace_indexed": "✅ «{title}» indexed ({chars} chars). Search: «find lease contract».",
    "workspace_indexed_short": "📂 Indexed: {chars} chars.",
    "doc_saved_indexed": "✅ {name} saved and indexed ({chars} chars).",
    "edu_export_format_pptx": "PowerPoint (PPTX)",
}
