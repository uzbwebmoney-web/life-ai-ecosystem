...
MODULES: tuple[ModuleDef, ...] = (
    ...
    ModuleDef(
        "sport", "⚽", "Спорт", "Sport", "Sport", 2, "Спорт",
        "Футбольная аналитика, статистика, матчи, сравнение команд, уведомления о матчах.",
        (
            _sub("analytics", "Футбольная аналитика", "Futbol tahlili", "Football analytics"),
            _sub("stats", "Статистика", "Statistika", "Statistics"),
            _sub("matches", "Анализ матчей", "O'yin tahlili", "Match analysis"),
            _sub("teams", "Сравнение команд", "Jamoalarni solishtirish", "Team comparison"),
            _sub("alerts", "Уведомления о матчах", "O'yin bildirishnomalari", "Match alerts"),
        ),
    ),
    ModuleDef(
    ...
    ModuleDef(
        "fitness", "🏋️", "Фитнес", "Fitnes", "Fitness", 2, "Спорт",
