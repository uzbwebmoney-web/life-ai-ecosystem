...
def generic_module_kb(module_id: str, lang: str = "ru") -> InlineKeyboardMarkup:
    mod = MODULE_BY_ID[module_id]
    rows = [
        [InlineKeyboardButton(text=sub.title(lang), callback_data=f"sub:{module_id}:{sub.id}")]
...
def generic_ai_kb(module_id: str, sub_id: str, lang: str = "ru") -> InlineKeyboardMarkup:
