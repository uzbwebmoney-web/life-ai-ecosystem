...
def shopping_module_kb(lang: str = "ru") -> InlineKeyboardMarkup:
    mod = MODULE_BY_ID["shopping"]
    rows = [
        [InlineKeyboardButton(text=sub.title(lang), callback_data=f"sub:shopping:{sub.id}")]
...
def shopping_ai_kb(module_id: str, sub_id: str, lang: str = "ru") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text=t(lang, "btn_back_module"), callback_data="mod:shopping")],
        ]
    )
