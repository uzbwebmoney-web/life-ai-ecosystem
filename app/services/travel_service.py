...
TRAVEL_SUBMODULE_AI: dict[str, str] = {
    ...
    "visas": (
        "Давай справочную информацию о визах для граждан Узбекистана (паспорт Республики Узбекистан), "
        "если пользователь явно не назвал другую страну паспорта. Указывай: нужна ли виза, тип, типичные "
        "документы, сроки, куда обращаться. Не подставляй Россию или другие страны по умолчанию. "
        "Предупреждай, что правила меняются — проверять на сайте консульства."
    ),
    "budget": (
