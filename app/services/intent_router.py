...
INTENT_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "finance": ("деньг", "расход", "доход", "бюджет", "счет", "счёт", "инвест"),
    ...
    "ai_assistant": ("перевод", "translate", "tarjima", "программ", "python", "код", "debug"),
    "vault": ("хранилищ", "ombor", "vault", "паспорт", "полис", "гарант", "чек", "архив"),
    "nutrition": ("калори", "диет", "рецепт", "еда", "рацион", "белок", "вода", "питани"),
    "sport": ("футбол", "матч", "лига", "чемпионат", "гол", "transfer", "football"),
    "fitness": ("трениров", "фитнес", "зал", "подход", "повторен", "прогресс", "workout"),
}
