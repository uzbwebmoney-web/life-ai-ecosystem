...
INTENT_KEYWORDS: dict[str, tuple[str, ...]] = {
    "health": ("здоров", "симптом", "лекарств", "давлен", "анализ", "врач", "болит", "salomat", "dori", "shifokor", "og'riq"),
    "car": ("машин", "авто", "масл", "то ", "техосмотр", "штраф", "бензин", "двигател", "mashina", "avto", "yoqilg'i"),
    "finance": ("деньг", "расход", "доход", "бюджет", "счет", "счёт", "инвест", "pul", "xarajat", "daromad", "byudjet"),
    "business": ("бизнес", "маркетинг", "конкурент", "реклам", "продаж", "клиент", "стартап", "crm", "biznes", "sotuv"),
    "legal": ("закон", "договор", "жалоб", "наслед", "юрист", "суд", "заявлен", "иск", "право", "документ", "huquq", "shartnoma", "sud"),
    "travel": ("виза", "билет", "отель", "путешеств", "рейс", "маршрут", "чемодан", "валют", "перевод", "viza", "sayohat", "bilet", "mehmonxona"),
    "home": ("дом", "коммунал", "квартир", "ремонт", "инвентар", "холодильник", "свет", "газ", "вода", "uy", "kommunal", "ta'mirlash"),
    "shopping": ("купить", "товар", "скидк", "маркетплейс", "ozon", "aliexpress", "сравн", "характеристик", "sotib", "chegirma"),
